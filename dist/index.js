...
var TimeBlock = ({ duration, currentTime }) => {
  return /* @__PURE__ */ jsxs(Typography.Text, { style: { color: "#fff", whiteSpace: "nowrap" }, children: [
...
var VideoPlayerControls = (props) => {
  ...
  if (variant === "tiny") {
    return /* @__PURE__ */ jsx(VideoPlayerControlStyles, { $tiny: true, $isMobile: isMobile, onClick: stopControlClick, $showControl: showControl, children: /* @__PURE__ */ jsxs(Flex, { gap: "small", align: "center", justify: "space-between", children: [
  ...
  if (variant === "fullscreen-only") {
    return /* @__PURE__ */ jsx(VideoPlayerControlStyles, { $isMobile: isMobile, onClick: stopControlClick, $showControl: showControl, children: /* @__PURE__ */ jsxs(Flex, { gap: "small", align: "center", justify: "space-between", children: [
      /* @__PURE__ */ jsx("div", { className: "full" }),
      /* @__PURE__ */ jsx(Button, { size: "small", onClick: () => onMutedChange(!muted), icon: muted ? /* @__PURE__ */ jsx(MutedFilled, {}) : /* @__PURE__ */ jsx(SoundFilled, {}) }),
      /* @__PURE__ */ jsx(Button, { size: "small", onClick: fullScreenAction, icon: /* @__PURE__ */ jsx(FullscreenOutlined, {}) })
    ] }) });
  }
  return /* @__PURE__ */ jsx(VideoPlayerControlStyles, { $isMobile: isMobile, onClick: stopControlClick, $showControl: showControl, children: /* @__PURE__ */ jsxs(Flex, { gap: "small", align: "center", justify: "space-between", children: [
    playing ? /* @__PURE__ */ jsx(Button, { size: "small", onClick: () => pauseAction(), icon: /* @__PURE__ */ jsx(PauseOutlined, {}) }) : /* @__PURE__ */ jsx(Button, { size: "small", onClick: () => playAction(), icon: /* @__PURE__ */ jsx(PlaySquareFilled, {}) }),
    /* @__PURE__ */ jsx(Button, { size: "small", onClick: () => seekPrevAction(), icon: /* @__PURE__ */ jsx(BackwardFilled, {}) }),
    /* @__PURE__ */ jsx(Button, { size: "small", onClick: () => seekNextAction(), icon: /* @__PURE__ */ jsx(FastForwardFilled, {}) }),
    /* @__PURE__ */ jsx(Typography.Text, { ellipsis: true, className: "video-player-control-title", children: title }),
    /* @__PURE__ */ jsx("div", { className: "full" }),
    /* @__PURE__ */ jsx(SeekSlider, { playAction, duration, currentTime, seekSetTime }),
